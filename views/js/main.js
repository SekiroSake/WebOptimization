...
function changePizzaSizes(size) {
  ...
  for(var i = 0, j = pizzaContainer.length; i < j; i++){
...
// This for-loop actually creates and appends all of the pizzas pizzasDivwhen the page loads
...
function updatePositions() {
  ...
  //moved var top and phase outside of the loop
  var top = document.body.scrollTop / 1250;
  var phase;
  for (var i = 0/*start*/,itemLength = items.length/*end*/; i < itemLength; i++) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  //moved var elem to the outside of the for loop
  var elem;
